...
const LandingPage = () => {
  ...
  return (
    ...
    {/* Footer */}
    <footer className='bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-12 px-6 md:px-8 lg:px-12'>
      <div className='max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8'>
      
        <div className='flex flex-col items-center lg:items-start'>
          <h2 className='text-4xl md:text-5xl font-bold quicksand-bold  text-lime-400  bg-clip-text  animate-pulse'>
            Synapse
          </h2>
        </div>
        
        <div className='flex flex-col items-center lg:items-end gap-4'>
          <p className='text-lg md:text-xl quicksand-medium text-gray-300 text-center lg:text-right'>
          ...
          <div className='flex items-center gap-4'>
            ...
            <a
              ...
              className='group p-3 bg-gray-800 rounded-full hover:bg-gray-700 transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-lime-400/30'
              aria-label="Follow on X"
            >
              <svg className='w-6 h-6 text-white group-hover:text-lime-400 transition-colors duration-300' fill='currentColor' viewBox='0 0 24 24'>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className='group p-3 bg-gray-800 rounded-full hover:bg-gray-700 transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-cyan-400/30'
