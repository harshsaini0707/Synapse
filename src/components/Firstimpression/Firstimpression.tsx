      ...
      <div className="relative container mx-auto px-4 pt-32 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-4">
          ...
          <div 
            ...
            className="relative group cursor-pointer flex justify-center items-center w-auto h-auto p-4 bg-transparent transition-all duration-300 ease-in-out hover:bg-lime-400/30 select-none"
          >
            {/* Animated Lines */}
